...
%:                  논문 제목과 저자 이름을 입력하시오
% ----------------------------------------------------------------------
\title{소형 천체망원경의 자동화를 위한 GS-system 개발} %한글 제목
\engtitle{Development of GS-system for Automation of Small Astronomical Telescope} %영문 제목
...
\judgeone{박 수 종} %심사위원장
\judgetwo{박 우 진}   %심사위원1
\judgethree{박 기 현} %심사위원2(지도교사)
\degreeyear{2020}   %졸업 년도
\degreedate{2020}{8}{20} %논문 승인 날짜 양식
