...
//
// ASCOM Focuser driver for TFocuser
//
// Description:	TFocuser is an ASCOM Driver for running the Tfocuser.ino code for Arduino. 
//
...
{
    //
    // Your driver's DeviceID is ASCOM.TFocuser.Focuser
    //
    // The Guid attribute sets the CLSID for ASCOM.TFocuser.Focuser
    // The ClassInterface/None addribute prevents an empty interface called
    // _TFocuser from being created and used as the [default] interface
    //
    //
            ...
            set
            {
                ...
                if (value)
                {
                     ...
                     try
                    {
                        ...
                        // Show the Window for the TFocuser here
                        if (showUI)
                        {
                            mainWindow = new MainWindow(this);
                            mainWindow.Show();
