...
// FIRMWARE START
#include <Arduino.h>
#include <Queue.h>                    // By Steven de Salas //JSJSJS
#include <EEPROM.h>                   // needed for EEPROM //JSJSJS
//#include <eepromanything.h>           // needed for EEPROM //JSJSJS
#ifdef TEMPERATUREPROBE
#include <Wire.h>                  //JSJSJS  // needed for DS18B20 temperature probe, see https://github.com/PaulStoffregen/OneWire
//#include <DallasTemperature.h>       //JSJSJS // needed for DS18B20 temperature probe, see https://github.com/milesburton/Arduino-Temperature-Control-Library
#endif
#ifdef OLEDDISPLAY
