...
// OUT3(B1)         RS232-1
// OUT4(B2)         RS232-2
// GND              Arduino GND and 12V GND
// +12V             12V+ DC Supply
// Onboard jumper   Shorted
// ----------------------------------------------------------------------------------------------------------
// DEFINABLE FEATURES
...
#define MOTORSPEEDMED2    2000
#define MOTORSPEEDFAST0   2000
#define MOTORSPEEDFAST2   1000
#define motorSpeedSlowRPM 10
#define motorSpeedMedRPM  40
#define motorSpeedFastRPM 100
...
const String programName = "myFP-L298N";
...
void setMotorSpeedRPM(int mspeed )
{
  switch ( mspeed )
  {
    case SLOW: // slow
      ...
      {
        case FULLSTEP: // full steps
          motorSpeedRPM = motorSpeedSlowRPM; break;
        case HALFSTEP: // half steps
          motorSpeedRPM = motorSpeedSlowRPM * 4; break;
      }
      break;
    case MED: // medium
      switch (myfocuser.stepmode)
      {
        case FULLSTEP: // full steps
          motorSpeedRPM = motorSpeedMedRPM; break;
        case HALFSTEP: // half steps
          motorSpeedRPM = motorSpeedMedRPM * 3; break;
      }
      break;
    case FAST: // fast
      switch (myfocuser.stepmode)
      {
        case FULLSTEP: // full steps
          motorSpeedRPM = motorSpeedFastRPM; break;
        case HALFSTEP: // half steps
          motorSpeedRPM = motorSpeedFastRPM + (motorSpeedFastRPM / 2); break;
      }
      break;
  }
#ifdef DEBUG
...
void processCommand()
{
  ...
  switch ( cmdval )
  {
    ...
    case 21325: // set motorSpeed - time delay between pulses, acceptable values are 00, 01 and 02 which
      ...
      setMotorSpeedRPM(motorSpeedRPM);
      break;
