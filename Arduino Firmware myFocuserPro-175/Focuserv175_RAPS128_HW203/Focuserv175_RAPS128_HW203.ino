// myfocuser RAPS128
// RAPS-HW203 BOARD REVISION ONLY
// ONLY FOR USE RAPS128 Driver Board - supports 1.5A at 12VDC and microstepping
...
#define myM1            6
#define myM0            7
// m0/m1/m2 sets stepping mode 000 = F, 100 = 1/2, 010 = 1/4, 110 = 1/8, 001 = 1/16, 101 = 1/32, 110 = 1/64, 111 = 128
// steps per revolution = 200, 400, 800, 1600, 6400, 12800, 25600
...
const String programName = "myFP-RAPS128";
  ...
  switch ( motorSpeed )
  {
    case 0: // slow
      switch (myfocuser.stepmode)
      {
        ...
        case 128: // 1/128 steps
          motorSpeedDelay = MOTORSPEEDSLOW128; break;
        default:
          motorSpeedDelay = MOTORSPEEDSLOW2; break;
      }
      break;
    case 1: // medium
      switch (myfocuser.stepmode)
      {
        ...
        case 128: // 1/128 steps
          motorSpeedDelay = MOTORSPEEDMED128; break;
          default:
          motorSpeedDelay = MOTORSPEEDMED2; break;
      }
      break;
    case 2: // fast
      switch (myfocuser.stepmode)
      {
        ...
        case 128: // 1/128 steps
          motorSpeedDelay = MOTORSPEEDFAST128; break;
        default:
          motorSpeedDelay = MOTORSPEEDFAST2; break;
      }
      break;
...
void enableoutput()
{
  ...
  // this is the reverse of the DRV8825
}
...
void displaylcdpage1()
{
  ...
  if ( myfocuser.stepmode == 1 )
    ...
    lcd.print("32");
  else if ( myfocuser.stepmode == 64 )
    lcd.print("64");
  else if ( myfocuser.stepmode == 128 )
    lcd.print("+1");
}
