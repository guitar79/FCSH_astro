...
// 
// This is NOT for the HW203 build
...
int stepontime = 5;          // changed 20141230 - seems better when 1/4 and 1/8 stepping
// motorSpeed - time in milisecobds of delay between stepper pulses
int motorSpeedSlow = 40;         // for 1000 half steps = about 56s
int motorSpeedMed = 18;          // for 1000 half steps = about 36s
int motorSpeedFast = 3;          // for 1000 half steps = about 18s
