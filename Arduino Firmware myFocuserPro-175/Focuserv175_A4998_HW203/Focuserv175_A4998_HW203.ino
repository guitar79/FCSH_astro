...
// FOR USE WITH A4998-HW203 BOARD LAYOUT ONLY
// ONLY FOR USE A4998 Driver Board - supports 1A at 12VDC and microstepping
...
#define myMS1           7
#define myMS2           6
#define myMS3           5         // MS1/MS2/MS3 sets stepping mode 000=F, 100=1/2, 010=1/4, 110=1/8, 001=1/16, 101=1/16, 110=1/16 etc
...
const String programName = "myFP-A4998HW203";
...
void setstepmode()
{
  ...
  {
    case 1:      // full step
      digitalWrite(myMS1, 0);
      digitalWrite(myMS2, 0);
      digitalWrite(myMS3, 0);
      break;
    case 2:      // half step
      digitalWrite(myMS1, 1);
      digitalWrite(myMS2, 0);
      digitalWrite(myMS3, 0);
      break;
    case 4:
      digitalWrite(myMS1, 0);
      digitalWrite(myMS2, 1);
      digitalWrite(myMS3, 0);
      break;
    case 8:
      digitalWrite(myMS1, 1);
...
void setup()
{
  ...
  pinMode(  myMS1, OUTPUT );
  pinMode(  myMS2, OUTPUT );
  pinMode(  myMS3, OUTPUT );
