...
namespace ASCOM.GSfocus
{
    ...
    /// ASCOM Focuser Driver for GSfocus.
    /// </summary>
    [Guid("5156c2c5-9035-4ea4-86e3-c20b3452f340")]
    ...
    public class Focuser : IFocuserV3
    {
        ...
        private bool connectedState = false; //»ùÃß°¡
            ...
            try
            {
                ...
                if (message.Contains("TEMPERATURE"))
                {
                    ...
                    OnFocuserTemperatureChanged(
                        new FocuserTemperatureChangedEventArgs(message.Split(':')[1] + " ¡ÆC"));
                }
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "Information about the GSfocus ASCOM platform Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{1}", version.Major, version.Minor);
