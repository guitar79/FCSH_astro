...
\begin{figure}[H]
	...
	\begin{center}
		\includegraphics[width=0.6\linewidth]{mainwindow1} 
	\end{center}			
	\caption{Briefly mainWindow}
	\label{fig:mainwindow1}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
	\begin{center}			
		\includegraphics[width=0.6\linewidth]{mainwindow2}
	\end{center}
	\caption{Advanced setting mainWindow}
