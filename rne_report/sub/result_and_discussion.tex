...
\begin{figure}[h]
	...
	\end{center}
	\begin{tikzpicture} [remember picture, overlay]
	\node[rectangle, draw, fill=black!10, minimum size=0.2] at (3.3, 4.4) {(a)};
	\node[rectangle, draw, fill=black!10, minimum size=0.5, font=\fontsize{60}{60}] at (3.3, 3.4) {(a)};
	\node[rectangle, draw, fill=black!10, minimum size=0.5, font=\fontsize{20}{20}] at (13.4, 3.4) {(b)};
