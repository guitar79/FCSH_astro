...
\begin{figure}[h]
	\subfloat{\includegraphics[width = 5cm]{arduino_nano}} 
	\subfloat{\includegraphics[width = 3cm]{DRV8825}}
	\subfloat{\includegraphics[width = 2cm]{DHT22}}
	\subfloat{\includegraphics[width = 4cm]{OLED}} 
