...
\begin{figure}[h]
	...
	\draw[draw=red, line width=0.5mm] (0.3,2.05) rectangle (6.8,2.6);
	\draw[draw=red] (-0.2, 2.3) node {(a)};
	\draw[draw=red, line width=0.5mm] (7.2,2.05) rectangle (12.2,2.6);
	\draw[draw=red] (12.5, 2.3) node {(b)};
	\draw[draw=red, line width=0.5mm] (7.0,2.05) rectangle (2.8,2.6);
	\draw[draw=red] (9.0, 2.3) node {(c)};
	\draw[draw=red, line width=0.5mm] (7.0,2.05) rectangle (2.8,2.6);
	\draw[draw=red] (9.0, 2.3) node {(d)};
	\end{tikzpicture}
	\end{center}
