/*
   ...
   See the corresponding Config.xxx.h file for detailed information 
   on this pin map to be sure it matches your wiring

*/

// === CONFIGURATION START

#define FCSH_Kevin_touch_ON
#ifdef  FCSH_Kevin_touch_ON
